...
$query = "INSERT INTO tblbooking (booking_id, place, duration, check_in, description, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
