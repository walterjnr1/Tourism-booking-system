            ...
            <div class="row justify-content-center" id="payment">
                <div class="col-lg-8 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <input type="hidden" id="hidamount" name="hidamount" value="<?php echo $amount; ?>"> </p>
...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    key: 'pk_test_9180e4cbc4f6da45138bf24d6e5a4fce84439c58', // Replace with your public key
    email: document.getElementById("hidemail").value,
    amount: document.getElementById("hidamount").value * 100,
    currency: 'NGN',
    ...
    onClose: function(){
        window.location="http://localhost/tourism_booking_system/home/index.php?transaction=Cancelled";
      ...
      alert(message);
window.location="http://localhost/tourism_booking_system/home/verify.php?amt="+encodeURIComponent(document.getElementById("hidden_amt").value)+"&email=" +encodeURIComponent(document.getElementById("txtemail").value)+"&phone=" +encodeURIComponent(document.getElementById("txtphone").value)+"&reference=" + response.reference    }
  });
