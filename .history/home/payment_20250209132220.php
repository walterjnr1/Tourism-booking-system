...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    onClose: function(){
      ...
      alert(message);
window.location="http://localhost/tourism_booking_system/home/verify.php?amt="+encodeURIComponent(document.getElementById("hidamount").value)+"&email=" +encodeURIComponent(document.getElementById("txtemail").value)+"&phone=" +encodeURIComponent(document.getElementById("txtphone").value)+"&reference=" + response.reference    }
  });
