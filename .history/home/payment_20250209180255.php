...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    alert(message);
    window.location="http://localhost/tourism_booking_system/home/verify.php?amount="+encodeURIComponent(document.getElementById("hidtotal").value)+"&email=" +encodeURIComponent(document.getElementById("hidemail").value)+"&place=" +encodeURIComponent(document.getElementById("hidplace").value)+"&place=" +encodeURIComponent(document.getElementById("hidplace").value)+"&place=" +encodeURIComponent(document.getElementById("hidplace").value)+"reference=" + response.reference    }
  });
