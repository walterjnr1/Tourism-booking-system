...
$query = "INSERT INTO tblbooking (name, address, category, amount, description, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
