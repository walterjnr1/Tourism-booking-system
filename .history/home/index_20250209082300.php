...
$query = "INSERT INTO tblbooking (booking_id, place, duration, check_in, checkout, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
