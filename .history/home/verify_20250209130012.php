...
header("Location:javascript://history.go(-1)");
  ...
  //save payment details
    $sql = 'INSERT INTO tblpayment(user,payment_id,description,amount,payment_date,channel) VALUES(user:,:payment_id,:description,:amount,:payment_date,:channel,:payment_date,:school_session)';
