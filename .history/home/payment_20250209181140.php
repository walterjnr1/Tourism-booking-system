...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    ref: 'Booking'+Math.floor((Math.random() * 10000000000000) + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
