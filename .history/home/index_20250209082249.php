...
$query = "INSERT INTO tblbooking (booking_id, place, duration, amount, description, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
