...
$query = "INSERT INTO tblbooking (booking_id, place, category, amount, description, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
