...
$query = "INSERT INTO tblbooking (booking_id, address, category, amount, description, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
