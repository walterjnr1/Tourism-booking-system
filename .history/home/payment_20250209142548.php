...
<body>
            ...
            <div class="row justify-content-center" id="payment">
                <div class="col-lg-8 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <input type="hidden" id="hidamount" name="hidtotal" value="<?php echo $total; ?>"> </p>
    ...
    <input type="hidden" id="hidden_publickey" name="hidden_publickey" value="<?php echo $publickey; ?>"> </p>
...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    key: 'pk_test_9180e4cbc4f6da45138bf24d6e5a4fce84439c58', // Replace with your Paystack public key
    email: document.getElementById("hidemail").value,
    amount: document.getElementById("hidtotal").value * 100,
    currency: 'NGN',
    ref: 'Booking'+Math.floor((Math.random() * 1000000000) + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
    // label: "Optional string that replaces customer email"
    onClose: function(){
        window.location="http://localhost/online_payment_system/index.php?transaction=Cancelled";
      alert('Transaction Cancelled.');
    },
       callback: function(response){
      let message = 'Admission Payment complete! Reference: ' + response.reference + ' . Kindly save the reference ID for future use.';
      alert(message);
window.location="http://localhost/online_payment_system/verify_admissionfee_pay.php?amt="+encodeURIComponent(document.getElementById("hidden_amt").value)+"&email=" +encodeURIComponent(document.getElementById("txtemail").value)+"&phone=" +encodeURIComponent(document.getElementById("txtphone").value)+"&reference=" + response.reference    }
  });
