            ...
            <div class="row justify-content-center" id="payment">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-euro mx-auto mb-4"></i>
                        <h5 class="mb-2">Paystack</h5>
                        
                        <p class="m-0">Place   :<?php echo $place; ?>, <?php echo $address; ?></p>
                        <p class="m-0">Amount  :<?php echo $amount; ?></p>
                        <p class="m-0">Duration: <?php echo $days; ?>  Starting : <?php echo $start; ?></p>


                        //add a button with formatted amount on the button
                        <button class="btn btn-primary" onclick="window.location.href='https://paystack.co
                        .ng/pay/<?php echo $paystack_ref; ?>'">Pay <?php echo $amount
                    </div>
                </div>
