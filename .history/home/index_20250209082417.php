...
$query = "INSERT INTO tblbooking (booking_id, place, duration, check_in, checkout,amount) VALUES ('$bookingid', '$id', '$duration', '$amount', '$description', '$uploadedImage','$capacity')";
