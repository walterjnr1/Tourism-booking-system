...
$query = "INSERT INTO tblbooking (booking_id, place, duration, check_in, checkout,amount) VALUES ('$bookingid', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
