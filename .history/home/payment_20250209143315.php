...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    alert(message);
    window.location="http://localhost/tourism_booking_system/home/verify.php?amount="+encodeURIComponent(document.getElementById("hidtotal").value)+"&email=" +encodeURIComponent(document.getElementById("hidemail").value)+"&phone=" +encodeURIComponent(document.getElementById("txtphone").value)+"&reference=" + response.reference    }
  });
