...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    onClose: function(){
      ...
      alert(message);
window.location="http://localhost/tourism_booking_system/home/verify_admissionfee_pay.php?amt="+encodeURIComponent(document.getElementById("hidden_amt").value)+"&email=" +encodeURIComponent(document.getElementById("txtemail").value)+"&phone=" +encodeURIComponent(document.getElementById("txtphone").value)+"&reference=" + response.reference    }
  });
