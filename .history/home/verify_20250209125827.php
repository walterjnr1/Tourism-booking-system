...
header("Location:javascript://history.go(-1)");
  ...
  //save payment details
    $sql = 'INSERT INTO tblpayment(payment_id,description,amount,payment_date,channel) VALUES(:referenceID,:amount,:phone,:email,:purpose,:payment_date,:school_session)';
