...
$query = "INSERT INTO tblbooking (booking_id, place, duration, check_in, check, photo,capacity) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
