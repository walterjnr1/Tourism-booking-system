    ...
    if ($image['error'] == 0) {
        ...
        if (in_array($imageExtension, array('jpg', 'jpeg', 'png'))) {
          ...
          $uploadedImage="uploadImage/places/" . $_FILES["image"]["name"];
            ...
            $query = "INSERT INTO places (name, address, category, amount, description, photo,capacity,status) VALUES ('$name', '$address', '$category', '$amount', '$description', '$uploadedImage','$capacity')";
