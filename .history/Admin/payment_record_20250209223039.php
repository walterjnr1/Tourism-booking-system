              ...
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <?php
		$sql = "SELECT tblusers.name,tblusers.photo,tblpayment.payment_id,tblpayment.amount,tblpayment.payment_date,tblpayment.channel FROM tblusers INNER JOIN tblpayment ON tblusers.username = tblpayment.user order by tblpayment.payment_date desc";
                     ...
                     <tr class="gradeX">
                       ...
                       <td><div align="center"><span class="controls"><img src="../<?php echo $row1['photo'];?>"  width="50" height="43" border="2"/></span></div></td>
                        ...
                        <td><div align="center">N<?php echo number_format((float) $row1['amount'] ,2); ?></div></td>
						         <td class="center"><?php echo $row1['channel'];  ?></td>
