...
<head>
  ...
  <title> Payment Record| <?php echo $sitename ;?> </title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Funding Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <?php
		$sql = "SELECT users.fullname,users.photo,tblpayment.referenceID,tblpayment.amt,tblpayment.payment_Date,tblpayment.payment_channel FROM users INNER JOIN tblpayment ON users.email = tblpayment.email order by tblpayment.payment_Date desc";
                   ...
                   while($row1 = $result->fetch_assoc()) {
                     ...
                     <tr class="gradeX">
                       <td><?php echo $cnt;  ?></td>
                       <td><div align="center"><span class="controls"><img src="../<?php echo $row1['photo'];?>"  width="50" height="43" border="2"/></span></div></td>
                        <td><?php echo $row1['referenceID'];  ?> </td>
                        <td class="center"><?php echo $row1['fullname'];  ?> </td>
                        <td><div align="center">N<?php echo number_format((float) $row1['amt'] ,2); ?></div></td>
						         <td class="center"><?php echo $row1['payment_channel'];  ?></td>
						         <td class="center"><?php echo $row1['payment_Date'];  ?></td>
