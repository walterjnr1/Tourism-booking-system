              ...
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <?php
		$sql = "SELECT tblusers.fullname,tblusers.photo,tblpayment.referenceID,tblpayment.amt,tblpayment.payment_Date,tblpayment.payment_channel FROM users INNER JOIN tblpayment ON users.email = tblpayment.email order by tblpayment.payment_Date desc";
