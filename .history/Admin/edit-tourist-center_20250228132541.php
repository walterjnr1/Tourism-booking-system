...
$sql = " update places set name='$name',address='$address',amount='$amount',category='$category',description='$description' where id='$id'";
...
<head>
  ...
  <title> Edit Tourist Center| <?php echo $sitename ;?> </title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Tourist Center </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		 ...
		 <!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Tourist Center </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             <form  action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtname" id="exampleInputEmail1" size="77" value="<?php echo $row11['name'];   ?>">
                  </div>

				  <div class="form-group">
                    <label for="exampleInputPassword1">Address</label>
                    <input type="text" class="form-control" name="txtaddress" id="exampleInputPassword1" size="77" value="<?php echo $row11['address'];   ?>" >
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <?php
			      $sql = "select * from tblcategory order by name asc";
             $class = $dbh->query($sql);                       
             ...
             echo '</select>';
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtamount" id="exampleInputPassword1" size="77" value="<?php echo $row11['amount'];   ?>" >
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">Description</label>
                    <input type="text" class="form-control" name="txtdescription" id="exampleInputPassword1" size="77" value="<?php echo $row11['description'];   ?>" >
                  </div>
                </div>
