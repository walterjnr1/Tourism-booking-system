              ...
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <?php
		$sql = "SELECT tblusers.name,tblbooking.*,place.name as place_name FROM tblusers INNER JOIN tblbooking ON tblusers.username = tblbooking.user ON tblbooking.place = places.id order by tblbooking.id order asc";
