              ...
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <?php
		$sql = "SELECT tblusers.name,tblbooking.*,place.* FROM tblusers INNER JOIN tblbooking ON tblusers.username = tblbooking.user ON tblbooking.username = tblbooking.user order by tblbooking.id asc";
