              ...
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                        <?php
		$sql = "SELECT tblusers.name,tblpayment.payment_id,tblpayment.amount,tblpayment.payment_date,tblpayment.channel FROM tblusers INNER JOIN tblpayment ON tblusers.username = tblpayment.email order by tblpayment.payment_Date desc";
