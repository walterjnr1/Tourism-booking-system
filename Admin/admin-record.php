...
<head>
  ...
  <title>Admin Record| <?php  echo $sitename ; ?></title>
...
function unblockAdmin(fullname){
if(confirm("ARE YOU SURE YOU WISH TO UN-BLOCK " + " " + fullname + " " + " ?"))
{
return  true;
}
else {return false;
...
<script type="text/javascript">
function blockAdmin(fullname){
if(confirm("ARE YOU SURE YOU WISH TO BLOCK  " + " " + fullname + " " + " ?"))
{
return  true;
}
else {return false;
...
if(confirm("ARE YOU SURE YOU WISH TO DELETE  " + " " + fullname + " FROM DATABASE " +  " ?"))
{
return  true;
}
else {return false;
...
<div class="wrapper">
                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        ...
                        <th width="8%"><div align="center">Role</div></th>
                    ...
                    <tbody>
                                         <?php
                                          $sql = "SELECT * FROM tbladmin order by ID ASC";
  ...
  <?php if (($row['role']) == 'Super Admin') { ?>
    <div class="btn-group" style="pointer-events: none; opacity: 0.5;">
  <?php } else { ?>
    <div class="btn-group">
  <?php } ?>
    ...
    <div class="dropdown-menu" role="menu">
      <?php if (($row['status']) == ('1')) { ?>
        <a class="dropdown-item" href="block-unblock-admin.php?id=<?php echo $row['id'];?>" onClick="return blockAdmin('<?php echo $row['fullname']; ?>');">Block</a>
      <?php } else { ?>
        <a class="dropdown-item" href="block-unblock-admin.php?uid=<?php echo $row['id'];?>" onClick="return unblockAdmin('<?php echo $row['fullname']; ?>');">Unblock</a>
      <?php } ?>
      <a class="dropdown-item" href="edit-admin.php?id=<?php echo $row['id'];?>">Edit</a>
      <a class="dropdown-item" href="delete-admin.php?id=<?php echo $row['id'];?> " onClick="return deldata('<?php echo $row['fullname']; ?>');">Delete</a>
