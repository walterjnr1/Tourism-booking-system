...
<head>
  ...
  <title>Tourist Center Record| <?php  echo $sitename ; ?></title>
...
if(confirm("ARE YOU SURE YOU WISH TO DELETE  " + " " + name + " FROM DATABASE " + " ?"))
{
return  true;
}
else {return false;
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tourist Center Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <table width="1049" border="0" align="center">
            <tr>
              <td width="1043" height="214"><div class="card">
                ...
                <form action="add-tourist-center.php" method="get">
    <button type="submit" class="btn btn-primary">Add Tourist Center</button>
</form>                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> 
                      ...
                      <th width="13%"><div align="center">Tourist Center</div></th>
                      ...
                      <th width="8%"><div align="center">Description</div></th>
                    ...
                    <tbody>
                      ...
                      <tr class="gradeX">
                        ...
                        <td><div align="center"><span class="controls"><img src="../<?php echo $row['photo'];?>"  width="70" height="70" border="2"/></span></div></td>
    ...
    <div class="dropdown-menu" role="menu">
      ...
      <a class="dropdown-item" href="edit-tourist-center.php?id=<?php echo $row['id'];?>">Edit</a>
      <a class="dropdown-item" href="delete-tourist-center.php?id=<?php echo $row['id'];?> " onClick="return deldata('<?php echo $row['name']; ?>');">Delete</a>
