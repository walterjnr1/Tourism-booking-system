...
$sql = " update tbladmin set photo='$location' where username='$username'";

     if (mysqli_query($conn, $sql)) {

      header( "refresh:2;url= edit-photo.php" );

      $_SESSION['success']='Photo Editted Successfuly';
    }else{
...
<head>
  ...
  <title> Edit Admin Profile| <?php echo $sitename ;?> </title>
		 ...
		 <!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Admin Photo </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             <form  action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                       ...
                       <div class="col-sm-6">
                      <p class="text-center">
                                    <img src="../<?php echo $row2['photo'];   ?>" alt="Admin logo" width="166" height="147" id="logo-img">
									 </p>

                  <input name="userImage" type="file" size="377" class="form-control" accept="image/png,image/jpeg,image/jpg" onChange="display_img(this)" required/>
