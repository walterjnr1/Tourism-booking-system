...
$sql = "SELECT * FROM tbladmin WHERE username='".$username."' and password = '".$password."' and status = '1'";
...
<title>Admin Login Form | <?php echo $sitename ;?> </title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><img src="../<?php echo $logo;   ?>" width="111" height="93"><span class="style4"></span></b></a>  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <a href="forgot-password.php" class="style3">Do You Forgot Password?</a> </div>
      </form>
